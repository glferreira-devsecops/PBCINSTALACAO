    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="order-1 lg:order-2" appAnimateOnScroll [style.transition-delay]="'150ms'">
          <img ngSrc="assets/images/arcond4.webp" alt="Técnico da PBC Instalação RJ realizando manutenção profissional" class="rounded-xl shadow-2xl w-full bg-slate-200" width="1260" height="750" priority>
        </div>
      </div>
    </div>
  </section>
